...
pkgdatadir = $(datadir)/vdif2psrfits
pkgincludedir = $(includedir)/vdif2psrfits
pkglibdir = $(libdir)/vdif2psrfits
pkglibexecdir = $(libexecdir)/vdif2psrfits
...
am__aclocal_m4_deps = $(top_srcdir)/config/ax_mpi.m4 \
	$(top_srcdir)/config/cfitsio.m4 \
	$(top_srcdir)/config/etr_socket_nsl.m4 \
	$(top_srcdir)/config/fftw.m4 $(top_srcdir)/config/libtool.m4 \
	$(top_srcdir)/config/ltoptions.m4 \
	$(top_srcdir)/config/ltsugar.m4 \
	$(top_srcdir)/config/ltversion.m4 \
	$(top_srcdir)/config/lt~obsolete.m4 \
	$(top_srcdir)/config/package.m4 $(top_srcdir)/configure.ac
...
libVDIF_la_DEPENDENCIES =
am_libVDIF_la_OBJECTS = dec2hms.lo polyco.lo vdifio.lo \
	write_psrfits.lo cvrt2to8.lo mjd2date.lo \
	getVDIFFrameDetection.lo downsample.lo
libVDIF_la_OBJECTS = $(am_libVDIF_la_OBJECTS)
AM_V_lt = $(am__v_lt_$(V))
...
CFITSIO_CFLAGS = -I/home/kliu/Soft/include/
CFITSIO_LIBS = -L/home/kliu/Soft/lib/ -lcfitsio -lpthread -lm 
CFLAGS = -g -O2
CPP = mpicc -E
CPPFLAGS = 
CYGPATH_W = echo
...
OTOOL = 
OTOOL64 = 
PACKAGE = vdif2psrfits
PACKAGE_BUGREPORT = kliu@mpifr-bonn.mpg.de
PACKAGE_NAME = VDIF2psrfits
PACKAGE_STRING = VDIF2psrfits 1.0
PACKAGE_TARNAME = vdif2psrfits
PACKAGE_URL = 
PACKAGE_VERSION = 1.0
PATH_SEPARATOR = :
RANLIB = ranlib
...
libVDIF.la: $(libVDIF_la_OBJECTS) $(libVDIF_la_DEPENDENCIES) $(EXTRA_libVDIF_la_DEPENDENCIES) 
	$(AM_V_CCLD)$(LINK) -rpath $(libdir) $(libVDIF_la_OBJECTS) $(libVDIF_la_LIBADD) $(LIBS)
